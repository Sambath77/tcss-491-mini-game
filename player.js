class Sant {
  constructor(game, x, y) {
    ...
    this.spritesheets = [
      ASSET_MANAGER.getAsset('./sprites/sant-right.png'),
      ASSET_MANAGER.getAsset('./sprites/sant-left.png'),
    ];
    ...
    if (this.dead) {
      ...
      this.game.entities.forEach(function (entity) {
          ...
          if (that.velocity.y > 0) {
            ...
            if (
              (entity instanceof Brickmoved ||
                entity instanceof BrickLevelOne) && // landin
        ...
        if (that.velocity.y < 0) {
          // jumping
          if (
            entity instanceof BrickLevelOne && // hit ceiling
